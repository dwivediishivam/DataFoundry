#!/usr/bin/env python3
"""
Test the improved system with better fallback handling
"""
import sys
import os
import asyncio
...
async def test_improved_system():
    ...
    try:
        ...
        print("🚀 TESTING IMPROVED DATAFOUNDRY SYSTEM")
        print("=" * 80)
        ...
        idea = "AI-powered personal finance advisor that analyzes spending patterns and provides investment recommendations for millennials"
        ...
        print("\n" + "=" * 80)
        print("✅ Improved system test completed successfully!")
